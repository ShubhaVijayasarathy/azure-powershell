...
namespace Microsoft.Azure.Commands.ServiceBus.Commands.Topic
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, ServicebusTopicVerb), OutputType(typeof(TopicAttributes))]
    public class NewAzureRmServiceBusTopic : AzureServiceBusCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            TopicAttributes sbTopicAttributes = Client.CreateUpdateTopic(ResourceGroup, NamespaceName, topicAttributes.Name, topicAttributes);
            WriteObject(sbTopicAttributes);
        }
    }
}
