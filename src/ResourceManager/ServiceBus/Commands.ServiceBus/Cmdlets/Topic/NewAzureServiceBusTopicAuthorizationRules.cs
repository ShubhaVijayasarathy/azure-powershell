...
namespace Microsoft.Azure.Commands.ServiceBus.Commands.Topic
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, ServiceBusTopicAuthorizationRuleVerb), OutputType(typeof(SharedAccessAuthorizationRuleAttributes))]
    public class NewAzureRmServiceBusTopicAuthorizationRule : AzureServiceBusCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            var authRule = Client.CreateOrUpdateServiceBusTopicAuthorizationRules(ResourceGroup, NamespaceName, TopicName, sasRule.Name, sasRule);
