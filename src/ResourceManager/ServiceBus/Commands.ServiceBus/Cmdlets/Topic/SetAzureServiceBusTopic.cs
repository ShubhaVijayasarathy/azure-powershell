...
namespace Microsoft.Azure.Commands.ServiceBus.Commands.Topic
{
    ...
    public class SetAzureRmServiceBusTopic : AzureServiceBusCmdletBase
    {
        ...
        [Parameter(Mandatory = true,
            ValueFromPipelineByPropertyName = true,
            ParameterSetName = TopicParameterSetName,
            Position = 3,
        ...
        public override void ExecuteCmdlet()
        {
            ...
            TopicAttributes TopicAttributes = Client.CreateUpdateTopic(ResourceGroup, NamespaceName, topicAttributes.Name, topicAttributes);
