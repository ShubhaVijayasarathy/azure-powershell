...
namespace Microsoft.Azure.Commands.ServiceBus.Commands.Topic
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, ServiceBusTopicKeyVerb), OutputType(typeof(ListKeysAttributes))]
    public class NewAzureRmServiceBusTopicKey : AzureServiceBusCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            var keys = Client.NewTopicKey(ResourceGroup, NamespaceName, TopicName, AuthorizationRuleName, RegenerateKeys);
            WriteObject(keys);
        }
    }
}
