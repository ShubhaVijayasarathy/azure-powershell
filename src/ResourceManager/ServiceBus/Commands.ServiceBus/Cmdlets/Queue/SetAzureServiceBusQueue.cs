...
namespace Microsoft.Azure.Commands.ServiceBus.Commands.Queue
{
    ...
    public class SetAzureRmServiceBusQueue : AzureServiceBusCmdletBase
    {
        ...
        [Parameter(Mandatory = true,
            ValueFromPipelineByPropertyName = true,
            ParameterSetName = QueueParameterSetName,
            Position = 3,
        ...
        public override void ExecuteCmdlet()
        {
            ...
            var ServiceBusAttributes = Client.CreateUpdateQueue(ResourceGroup, NamespaceName, queueAttributes.Name, queueAttributes);
            WriteObject(ServiceBusAttributes);
