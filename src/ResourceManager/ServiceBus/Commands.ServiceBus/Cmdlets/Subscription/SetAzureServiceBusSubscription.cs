...
namespace Microsoft.Azure.Commands.ServiceBus.Commands.Subscription
{
    ...
    public class SetAzureRmServiceBusSubscription : AzureServiceBusCmdletBase
    {
        ...
        [Parameter(Mandatory = true,
            ValueFromPipelineByPropertyName = true,
            ParameterSetName = SubscriptionParameterSetName,
            Position = 3,
        ...
        public override void ExecuteCmdlet()
        {
            ...
            SubscriptionAttributes ServiceBusAttributes = Client.CreateUpdateSubscription(ResourceGroup, NamespaceName, TopicName, subscriptionAttributes.Name, subscriptionAttributes);
